...
from politihub.extends.client import check_permissions
...
class GPUserProfile(Document):
	...
	def set_image(self, image):
		...
		self.save()
		politihub.refetch_resource("Users")
...
def remove_imgbg_in_background(profile_name, default_color=None):
	from politihub.politihub.doctype.gp_user_profile.profile_photo import remove_background
	...
	profile.save()
	politihub.refetch_resource("Users", user=profile.user)
